...
//        далее оно должно выводиться на экран (для тех, кто понимает в секундах) и на следующей строке (для тех кто не понимает) должна выводиться
//        фраза о количестве полных часов, содержащихся в n секундах.
public class ConvertingSecondToHours {
    public static void main(String[] args) {

        // Генерируем случайное количество секунд от 0 до 28800
        Random rand = new Random();
        int seconds = rand.nextInt(28801);

        // Выводим количество секунд на экран
        System.out.println("Осталось секунд: " + seconds);

        // Вычисляем количество полных часов
        int hours = seconds / 3600;

        // Выводим сообщение о количестве полных часов
        if (hours > 1) {
